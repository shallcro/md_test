...
Metadata Schema for Curated TEST Studies as of August 16, 2023.

| Property                                                     | Type                      | Description                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| (R) [Version](#version )                                     | integer                   | The current version number for the data collection.                                                                                                                                                                                                                                                                                                                            |
| (R) [Version Date](#version_date )                           | string                    | The date on which the current version of the data collection was released by TEST. Understand? Good.                                                                                                                                                                                                                                                                           |
...
**Description:** The date on which the current version of the data collection was released by TEST. Understand? Good.
